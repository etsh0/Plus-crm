...
export default function EditDealPage() {
  ...
  const handleSave = () => {
    console.log("Saving deal:", id, formData);
  ...
  return (
    <div className="max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Edit Deal</h1>
          <p className="text-gray-500 dark:text-white/40 text-sm mt-1">Update deal information for #{id}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 dark:border-white/[0.08] rounded-lg px-4 py-3 text-sm text-gray-900 dark:text-white outline-none focus:border-violet-500/50 dark:focus:border-[#a855f7]/50 transition-all resize-none"
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#1c1c1f] border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-sm mb-6 lg:mb-0">
        ...
        <div className="w-full lg:w-[350px] flex flex-col gap-6">
          ...
          {/* Deal Summary Card */}
          <div className="bg-white dark:bg-[#1c1c1f] border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Deal Info</h2>
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500 dark:text-white/40">Status:</span>
                <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400 capitalize">{formData.stage}</span>
              </div>
              <div className="flex items-center justify-between">
