          ...
          <div className="bg-[#18181b] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
            ...
            <div className="p-5 grid grid-cols-2 gap-x-4 gap-y-3">
              <div className="flex flex-col gap-1.5 col-span-2 sm:col-span-1">
                ...
                <input type="text" placeholder="John Doe" className="bg-[#27272a]/50 border border-white/5 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-[#a855f7]/50 focus:ring-1 focus:ring-[#a855f7]/50 transition-all" />
              </div>
              <div className="flex flex-col gap-1.5 col-span-2 sm:col-span-1">
                <label className="text-[11px] text-white/50 font-medium uppercase tracking-wider">Email</label>
                <input type="email" placeholder="john@example.com" className="bg-[#27272a]/50 border border-white/5 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-[#a855f7]/50 focus:ring-1 focus:ring-[#a855f7]/50 transition-all" />
              </div>
              <div className="flex flex-col gap-1.5 col-span-2 sm:col-span-1">
