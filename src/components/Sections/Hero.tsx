  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pt-40 pb-24 max-w-4xl mx-auto gap-7">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-violet-400/20 bg-violet-500/10 backdrop-blur-sm text-[10px] sm:text-xs font-medium text-violet-300 tracking-wide">
          <span className="w-1.5 h-1.5 rounded-full bg-violet-400 animate-pulse" />
          Now in public beta — free to get started
        </div>

        {/* Headline */}
        <h1 className="text-[34px] sm:text-6xl md:text-7xl font-bold leading-[1.08] tracking-tight text-white drop-shadow-[0_2px_24px_rgba(168,85,247,0.4)]">
          Your customers,{' '}
        ...
        {/* Sub-headline */}
        <p className="max-w-xl text-xs sm:text-lg text-white/55 leading-relaxed">
        ...
        {/* Social proof */}
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 mt-3">
